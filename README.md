...
Esse projeto está sob a licença MIT. Veja o arquivo [LICENSE](https://github.com/raphaelcaires/RocketQ/blob/main/LICENSE) para mais detalhes.

---

Feito com ♥ by [Raphael Caires](https://github.com/raphaelcaires).
